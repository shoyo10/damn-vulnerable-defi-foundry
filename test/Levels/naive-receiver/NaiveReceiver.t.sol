...
import {AttackFlashLoanReceiver} from "../../../src/Contracts/naive-receiver/AttackFlashLoanReceiver.sol";
...
contract NaiveReceiver is Test {
    ...
    function testExploit() public {
        ...
        new AttackFlashLoanReceiver(address(flashLoanReceiver), payable(naiveReceiverLenderPool));
        vm.stopPrank();
        /**
         * EXPLOIT END *
         */
